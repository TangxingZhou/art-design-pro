...
All pool parameters are configurable via variables:
    - AIOHTTP.POOL_CONNECTIONS (default 100) — max total connections
    - AIOHTTP.POOL_CONNECTIONS_PER_HOST (default 30) — per-host limit
    - AIOHTTP.POOL_DNS_TTL (default 300) — DNS cache TTL in seconds
