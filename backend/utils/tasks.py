...
REDIS_TASKS_KEY = f'{settings.REDIS.KEY_PREFIX}:tasks'
REDIS_ITEM_TASKS_KEY = f'{settings.REDIS.KEY_PREFIX}:tasks:item'
REDIS_PUBSUB_CHANNEL = f'{settings.REDIS.KEY_PREFIX}:tasks:commands'
